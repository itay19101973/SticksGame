...
DEFAULT_TIME = 40,
GAME_MENU_START_X = 80,
GAME_BUTTON_OFFSETS = 60,
GAME_MENU_START_Y = 25;
...
PLAY_BTN_POS = { WINDOW_MANAGER_WIDTH / 2 - MENU_BUTTON_DEFA_SIZE.x / 2,
	...
	EXIT_BTN_POS = { WINDOW_MANAGER_WIDTH / 2 - MENU_BUTTON_DEFA_SIZE.x / 2,
						WINDOW_MANAGER_HEIGHT / 2 + 200 },
	HINT_BUTTON_POS = { GAME_MENU_START_Y , GAME_MENU_START_X },
	SAVE_BUTTON_POS = { GAME_MENU_START_Y , GAME_MENU_START_X + GAME_BUTTON_OFFSETS  };
	;
